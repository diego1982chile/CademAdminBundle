...
class Planogramap
{
     ...
     * Add precios
     *
     * @param \Cadem\AdminBundle\Entity\Precio $precios
     * @return Planogramap
     */
    public function addPrecios(\Cadem\AdminBundle\Entity\Precio $precios)
    {
     ...
     * @param \Cadem\AdminBundle\Entity\Precio $precios
     */
    public function removePrecio(\Cadem\AdminBundle\Entity\Precio $precios)
    {

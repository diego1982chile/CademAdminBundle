...
class Sala
{
	...
	/**
     * @ORM\OneToMany(targetEntity="Estudiosala", mappedBy="sala")
     */
	 
	protected $estudiosala;	
     ...
     * Set comuna
     *
     * @param \Cadem\AdminBundle\Entity\Comuna $comuna
     * @return Sala
     */
    public function setComuna(\Cadem\AdminBundle\Entity\Comuna $comuna = null)
    {
        $this->comuna = $comuna;
     ...
     * Get comuna
     *
     * @return \Cadem\AdminBundle\Entity\Comuna 
     */
     ...
     * Set formato
     *
     * @param \Cadem\AdminBundle\Entity\Formato $formato
     * @return Sala
     */
    public function setFormato(\Cadem\AdminBundle\Entity\Formato $formato = null)
    {
     ...
     * Get formato
     *
     * @return \Cadem\AdminBundle\Entity\Formato 
     */
     ...
     * Set cadena
     *
     * @param \Cadem\AdminBundle\Entity\Cadena $cadena
     * @return Sala
     */
    public function setCadena(\Cadem\AdminBundle\Entity\Cadena $cadena = null)
    {
        $this->cadena = $cadena;
     ...
     * Get cadena
     *
     * @return \Cadem\AdminBundle\Entity\Cadena 
     */
     ...
     * Set canal
     *
     * @param \Cadem\AdminBundle\Entity\Canal $canal
     * @return Sala
     */
    public function setCanal(\Cadem\AdminBundle\Entity\Canal $canal = null)
    {
        $this->canal = $canal;
     ...
     * Get canal
     *
     * @return \Cadem\AdminBundle\Entity\Canal 
     */

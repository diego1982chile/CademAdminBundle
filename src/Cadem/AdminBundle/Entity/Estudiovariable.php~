...
class Estudiovariable
{
     ...
     * Set estudio
     *
     * @param \Cadem\AdminBundle\Entity\Estudio $estudio
     * @return Estudiovariable
     */
     ...
     * Get estudio
     *
     * @return \Cadem\AdminBundle\Entity\Estudio 
     */
     ...
     * Set variable
     *
     * @param \Cadem\AdminBundle\Entity\Variable $variable
     * @return Estudiovariable
     */
    public function setVariable(\Cadem\AdminBundle\Entity\Variable $variable = null)
    {
     ...
     * Get variable
     *
     * @return \Cadem\AdminBundle\Entity\Variable 
     */
     ...
     * Add mediciones
     *
     * @param \Cadem\AdminBundle\Entity\Medicion $mediciones
     * @return Estudiovariable
     */
    public function addMedicione(\Cadem\AdminBundle\Entity\Medicion $mediciones)
    {
     ...
     * @param \Cadem\AdminBundle\Entity\Medicion $mediciones
     */
    public function removeMedicione(\Cadem\AdminBundle\Entity\Medicion $mediciones)
    {

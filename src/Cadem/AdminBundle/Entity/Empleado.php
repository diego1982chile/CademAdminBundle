...
class Empleado
{
     ...
     * Set cargo
     *
     * @param \Cadem\AdminBundle\Entity\Cargo $cargo
     * @return Empleado
     */
    public function setCargo(\Cadem\AdminBundle\Entity\Cargo $cargo = null)
    {
        $this->cargo = $cargo;
     ...
     * Get cargo
     *
     * @return \Cadem\AdminBundle\Entity\Cargo 
     */
     ...
     *
     * @param \Cadem\AdminBundle\Entity\Estudiovariable $estudiovariables
     * @return Empleado
     */
    public function addEstudiovariable(\Cadem\AdminBundle\Entity\Estudiovariable $estudiovariables)
    {
     ...
     * @param \Cadem\AdminBundle\Entity\Estudiovariable $estudiovariables
     */
    public function removeEstudio(\Cadem\AdminBundle\Entity\Estudiovariable $estudiovariables)
    {
